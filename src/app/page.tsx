...
const topicsURL = "https://fabconfworkshop001.blob.core.windows.net/$web/topics.json"
...
const QAsURL = "https://fabconfworkshop001.blob.core.windows.net/$web/generated-QAs.json"
